      ...
      if ($count != 0) {
          while ($row = mysqli_fetch_assoc($result)):
                  ...
                  <div class="row readmore">
                    <div class="col-lg-6">
                    <img class="readmore_img" src='admin/<?php echo $row['IMAGE']?>'/>
                    </div>
                    <div class="col-lg-6">
                    <div class="readmoretitle">
                  <h2 class="readmore_h2 fs-1"><?php echo $row['TITLE']; ?></h2>
                  <p class="readmore_date fs-3"><?php echo $month ?> <?php echo $day ?></p>
                  </div>
                  
                  <p class="fs-5 readmore_p"><?php echo $row['PARAGRAPH']; ?></p>
                  <?php
                  if(!empty($_SESSION))
                  {
                    ?>
