...
?>
    ...
    include 'DB.php';
      ...
      if(isset($_POST['signup']))
      {
		...
		$degree=$_POST['degree'];
		$type=$_POST['type'];
        if(strlen($_POST['firstname']) == 0 && strlen($_POST['lastname']) == 0 && strlen($_POST['email']) == 0 && strlen($_POST['password']) == 0 && strlen($_POST['jobplace']) == 0 && strlen($_POST['experience']) == 0 && strlen($_POST['degree']) == 0)
        {
          echo "<script>
          alert('fields are Empty please fill in the blanks');
              </script>";
        }
        else if(strlen($_POST['firstname']) == 0 || strlen($_POST['lastname']) == 0 || strlen($_POST['email']) == 0 || strlen($_POST['password']) == 0 || strlen($_POST['jobplace']) == 0 || strlen($_POST['experience']) == 0 || strlen($_POST['degree']) == 0){
          echo "<script>
