...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    $result = mysqli_query(
        $connect,
        "SELECT * FROM `news` LIMIT $offset, $total_records_per_page"
        );
        ?>
...
<div class="row g-2 news">
  ...
  $string = mb_strimwidth($para, 0, 50);
      ?>
<div class="col-lg-4 col-md-4 news_container">
<div class="p-3 news">
<center><img class="news_img" src='admin/<?php echo $rows['IMAGE']?>' height="80" width="100"/></center>
                  <h2 class="news_h2"><?php echo $rows['TITLE'] ?></h2>
                 <p class="news_p fs-6"><?php echo $string?></p>
                 <p class="date"><?php echo $month ?> <?php echo $day ?></p>
                 <a href="ReadMore.php?id=<?php echo $rows['ID']?>" class="news_a">Read More</a>
</div>
    </div>
